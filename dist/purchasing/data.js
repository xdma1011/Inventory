...
const PURCHASING_BRANCHES = {
    gardens: {
        ...
        items: [
            ...
            { sku: 'sk-0062', name: 'بندق', unit: 'G', min: null, supplier: 'الشعب', location: '' },
            { sku: 'sk-0063', name: 'جوز هند', unit: 'G', min: null, supplier: 'الشعب', location: '' },
            { sku: 'sk-0064', name: 'لوز', unit: 'G', min: null, supplier: 'الشعب', location: '' },
            { sku: 'sk-0065', name: 'كاجو', unit: 'G', min: null, supplier: 'الشعب', location: '' },
